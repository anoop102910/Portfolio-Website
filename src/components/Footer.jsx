  ...
  return (
    <div className="mt-32 ">
      <div id="footer" className="flex items-center gap-x-10 mx-auto w-min">
        ...
        <a target="2" className="w-20" href="https://wa.me/6388175878">
          <img src="./instagram.png" alt="" />
        </a>
        <a target="3" className="w-20" href="https://instagram.com">
          <img src="./linkedin.png" alt="" />
        </a>
        <a target="4" className="w-20" href="https://www.linkedin.com/in/anoop-singh-1a67ba252/">
