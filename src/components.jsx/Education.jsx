...
function Education() {
  return (
    <div id="education" className="mt-32 ">
      ...
      <div className="mt-20  ">
        <div className="edu-card-1  flex items-center gap-x-6 md:gap-x-20 md:ml-[45%] ">
          <div className="flex flex-col items-center gap-y-3 ">
            <div id="circle" className="circle"></div>
            <hr className="w-[2px] h-56 bg-white" />
          </div>
          <div className="mt-10">
        ...
        <div className="edu-card-2  flex gap-x-2 md:gap-x-20 mt-10 ml-[8%]">
          <div className="mt-10">
        ...
        <div className="edu-card-3  flex gap-x-6 md:gap-x-20 mt-10 md:ml-[45%]">
          <div className="flex flex-col items-center gap-y-4 ">
            <div id="circle" className="circle"></div>
            <hr className="w-[2px] h-56 bg-white" />
          </div>
